...
# This is based on the cars dataset from R’s datasets package

classdef cars < tblish.internal.dataset

  methods

    function this = cars
      this.name = "cars";
      this.summary = "Speed and Stopping Distances of Cars";
    endfunction
