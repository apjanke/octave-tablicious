...
You'll need the MP-Test library, which is installed separately, and is (I think) not available from Octave Forge. Clone it from the Git repo at <https://github.com/MATPOWER/mptest>. By default, Tablicious will look for MP-Test at `~/repos/mptest`.
