/*
Copyright (C) 2019, 2024 Andrew Janke <floss@apjanke.net>
...
DEFUN_DLD (__tblish_time_binsearch__, args, nargout,
  "Vectorized binary search\n"
  "\n"
  "-*- texinfo -*-\n"
  "@deftypefn {Function File} {@var{out} =} __tblish_time_binsearch__ (@var{needles}, @var{haystack})\n"
  "\n"
  "Undocumented internal function for the Tablicious package.\n"
  "\n"
  "@end deftypefn\n")
{
